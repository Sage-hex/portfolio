...
//   return (
//     <section className="relative overflow-hidden w-full min-h-screen flex flex-col justify-center text-black transition-colors duration-500 bg-white dark:bg-[#0E0E0E]">
//       {/* 🔮 Bubble Glow Top */}
//       {/* <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-gradient-to-br from-purple-400 via-pink-500 to-yellow-300 rounded-full blur-3xl opacity-30 animate-bubbleGlow z-0"></div> */}
...
//               <h2 className="font-medium text-center md:text-left text-2xl mb-2 font-semibold text-black dark:text-white">Biography</h2>
//               <p className="text-gray-400 text-sm">
//                 Getting Buff +1 for learning, Buff +2 for documentation, and more buff on managing teams. Excited about <span className="text-blue-500">React</span>, <span className="text-blue-300">UX Research</span>, and <span className="text-green-400">Agile Development</span>.
//               </p>
//             </div>
//           </div>
//         ) : (
...
//                   <h2 className="text-2xl mb-2 font-semibold text-black dark:text-white">Biography</h2>
//                   <p className="text-gray-300 max-w-lg text-lg">
//                     Getting Buff +1 for learning, Buff +2 for documentation, and more buff on managing teams.
//                     Excited about <span className="text-blue-500 font-semibold">React</span>, 
//                     <span className="text-blue-300 font-semibold"> UX Research</span>, and 
//                     <span className="text-green-400 font-semibold"> Agile Development</span>.
//                   </p>
//                 </div>
